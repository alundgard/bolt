...
function Instr_Control() {
	...
	this.startMsg = function() {
		var msg = 
				...
				<p>You will go through 3 practice rounds first, followed by 20 test rounds.</p>\
				<p style='color:red'>Note: The test rounds will be MUCH faster than the practice rounds.</p>\
				<p>Are you ready to try the practice rounds?</p>\
				<button id='repeat-button'>Repeat Instructions</button>\
				<button id='start-button'>Yes, I'm ready.</button>\
				</div>";
		this.append2Instr(msg);
	};
